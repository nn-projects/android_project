...
public class FragmentListEvent extends Fragment {
    ...
    private ListEventActivityRecyclerAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new ListEventActivityRecyclerAdapter();
        adapter.setDataListEvent(new ArrayList<>());

        eventViewModel.getAllEvents().observe(getActivity(), newEvent -> {
            // cast List<Item> to ArrayList<Item>
            adapter.setDataListEvent(new ArrayList<Event>(newEvent));
